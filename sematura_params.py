...
cella       =   43.1               # length of unit cell along a axis
cellb       =   52.6               # length of unit cell along b axis
cellc       =   89.3               # length of unit cell along c axis
target_sg   =   str(19)            # space group from Bragg data reduction
resolution  =   str(3.5)           # maximum resolution for diffuse data integration
...
image_prefix            =   'CypA_287K_x2_collect1_paratone_3_'
lunus_image_prefix      =   'CypA_287K_lunus_'
image_dir               =   '/netapp/home/awolff/287/xtal2'
phenix_dir              =   '/netapp/home/awolff/packages/phenix-dev-2499'

###-----------Choose files to use for indexing-----------###
indexing_one   = str(100)            # number of first file for indexing
indexing_two   = str(200)            # number of second file for indexing
indexing_three = str(300)            # number of third file for indexing
...
windim_xmin     =str(100)           # left border for processed image (pixels)
...
polarim_dist        =str(185)       # distance from sample to detector (mm)
